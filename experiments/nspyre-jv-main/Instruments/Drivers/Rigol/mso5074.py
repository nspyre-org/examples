...
# @Date:   2022-02-09T11:55:26-08:00
# @Email:  ericros@stanford.edu
# @Project: nspyre-jv
# @Last modified by:   Eric Rosenthal
# @Last modified time: 2022-07-19T11:01:15-07:00



# -*- coding: utf-8 -*-
"""
    lantz.drivers.rigol.mso5074
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class ScopeDriver(MessageBasedDriver):
    ...
    def get_waveform_trace(self, channel=None):
        ...
        y_inc = float(y_inc)
        y_or = float(y_or)
        x_ref = int(float(x_ref))
        y_ref = int(float(y_ref))
...
if __name__ == '__main__':
    ip_addr = '171.64.85.34'

    inst = ScopeDriver('TCPIP::{}::INSTR'.format(ip_addr))
    inst.initialize()
