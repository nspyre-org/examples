...
# testing class...
print('testing...')
m = Magnet(manager='', name='our_magnet')
print(m)
# print(m.__dict__)
# help(m)
a = m.get_magnet_idle_state()
print(a)
m.on_activate()
# m.ask_status()
print('testing... 2')
